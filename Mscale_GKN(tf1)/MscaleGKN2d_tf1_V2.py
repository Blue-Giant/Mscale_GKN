...
def solve_multiScale_operator(R):
    ...
    if R['model2kernel'] == 'Fourier_DNN':
        W2Kernel, B2Kernel = DNN_base.Xavier_init_NN_Fourier(3 * input_dim, out_dim, hidden2Kernel, flag2Kernel)
    else:
        W2Kernel, B2Kernel = DNN_base.Xavier_init_NN(3 * input_dim, out_dim, hidden2Kernel, flag2Kernel)
